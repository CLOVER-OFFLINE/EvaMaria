...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔱 𝙶𝚛𝚘𝚞𝚙', url='https://t.me/Mallu_Movie_Hub_Group')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔱 𝙶𝚛𝚘𝚞𝚙', url='https://t.me/Mallu_Movie_Hub_Group'),
            InlineKeyboardButton('📺 𝙲𝚑𝚊𝚗𝚗𝚎𝚕', url='https://t.me/CINEMA_CITY_UPDATES')
        ], [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "📺 𝙹𝚘𝚒𝚗 𝙲𝚑𝚊𝚗𝚗𝚎𝚕", url=invite_link.invite_link
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton(" 🔄 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗", callback_data=f"{pre}#{file_id}")])
            except (IndexError, ValueError):
                btn.append([InlineKeyboardButton(" 🔄 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗", url=f"https://t.me/{temp.U_NAME}?start={message.command[1]}")])
